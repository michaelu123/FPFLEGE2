...
MUH: copied this and android_email.py to be able to add attachments
...
class Email(object):
    ...
    def send(self, recipient=None, subject=None, text=None,
             create_chooser=None, attachment=None):
        '''
        ...
        self._send(recipient=recipient, subject=subject, text=text,
                   create_chooser=create_chooser, attachment=attachment)
